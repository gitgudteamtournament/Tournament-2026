...
import ProfileAdminOverlay from "./Overlay/Admin/ProfileAdminOverlay";
import ProfileJuryOverlay from "./Overlay/Juri/ProfileJuryOverlay";
...
import CreateTourOverlay from "./Overlay/Admin/CreateTourOverlay";
import TourPageRegistrOverlay from "./Overlay/Admin/TourPageRegistrOverlay";
        ...
        switch (CURRENT_USER_ROLE) {
            case 'Admin': return (
                <DashboardAdminOverlay
                    ...
                    onTourRegistr={() => setView('adminTourReg')}
                    onTourRunning={() => setView('adminTourRun')}
        ...
        <div className="min-h-screen w-full relative bg-[#f4f7fa] font-roboto antialiased text-[#1e293b]">
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-20">
                ...
                <AnimatePresence mode="wait">
                    ...
                    {view === 'adminTourReg' && (
                        <TourPageRegistrOverlay key="adminTourReg" onClose={resetView} />
                    )}
                    {view === 'adminTourRun' && (
                        <TourPageRunningOverlay key="adminTourRun" onClose={resetView} />
                    )}
                    {view === 'adminArchive' && (
                        <ArchiveTournamentPage key="adminArchive" onBack={resetView} />
                    )}
                </AnimatePresence>
            </div>
        </div>
