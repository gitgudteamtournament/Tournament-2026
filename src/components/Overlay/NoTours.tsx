...
export default function NoTours() {
    return (
        <motion.div
            ...
            className="w-full max-w-[1200px] mx-auto mt-8 bg-white/40 backdrop-blur-[20px] border border-white/60 rounded-[30px] p-8 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.02)] flex flex-col md:flex-row items-center justify-between min-h-[500px] relative overflow-hidden font-roboto"
        >
            ...
            <div className="absolute top-[-10%] right-[-5%] w-[400px] h-[400px] bg-[#5c75ff]/10 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[-5%] w-[300px] h-[300px] bg-[#C1E130]/5 blur-[100px] rounded-full pointer-events-none" />
        </motion.div>
    );
}